...
dec_reg_exp = '((([+]?)|([-]?))[0-9]*[.][0-9]*)|((([+]+)|([-]+))[0-9][0-9]d[0-5][0-9]m[0-5][0-9][.]*[0-9]*s)|((([+]+)|([-]+))[0-9.]+[.]*[0-9]*)|((([+]+)|([-]+))[0-9][0-9]d[0-5][0-9]\'[0-5][0-9][.]*[0-9]*\")'
ra_reg_exp = '([0-9]*[.][0-9]*)|([0-2][0-9]h[0-5][0-9]m[0-5][0-9][.]*[0-9]*s)|([0-9.]+[.]*[0-9]*)|([0-2][0-9]h[0-5][0-9]\'[0-5][0-9][.]*[0-9]*\")'
