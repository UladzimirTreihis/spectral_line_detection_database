...
class AdvancedSearchForm(FlaskForm):
    ...
    right_ascension_min = StringField('Right Ascension min:', validators = [Regexp(ra_reg_exp, message="Input in the format 00h00m00s or as a float"), Optional ()])
    right_ascension_max = StringField('Right Ascension max:', validators = [Regexp(ra_reg_exp, message="Input in the format 00h00m00s or as a float"), Optional ()])
    declination_min = StringField('Declination min:', validators = [Regexp(dec_reg_exp, message="Input in the format (+/-)00d00m00s or as a float"), Optional ()])
    declination_max = StringField('Declination max:', validators = [Regexp(dec_reg_exp, message="Input in the format (+/-)00d00m00s or as a float"), Optional ()])
    ...
    radius_d = FloatField('Radius deg', validators = [Optional (), NumberRange(min = 0, max = 180)])
    radius_m = FloatField('Radius arcmin', validators = [Optional (), NumberRange(min = 0, max = 60)])
    radius_s = FloatField('Radius arcsec', validators = [Optional (), NumberRange(min = 0, max = 60)])

    redshift_min = FloatField('Redshift min:', validators = [Optional ()])
    redshift_max = FloatField('Redshift max:', validators = [Optional ()])
    lensing_flag = SelectField(u'Gravitational Lensing', choices = [('Either', 'Either'), ('Lensed', 'Lensed'), ('Unlensed', 'Unlensed')], validate_choice=False)
...
class AddGalaxyForm(FlaskForm):
    ...
    classification = SelectMultipleField(u'Classification (Press shift to select all that apply)', choices = [('LBG (Lyman Break Galaxy)', 'LBG (Lyman Break Galaxy)'), ('MS (Main Sequence Galaxy)', 'MS (Main Sequence Galaxy)'), ('SMG (Submillimeter Galaxy)', 'SMG (Submillimeter Galaxy)'), ('DSFG (Dusty Star-Forming Galaxy)', 'DSFG (Dusty Star-Forming Galaxy)'), ('SB (Starburst)', 'SB (Starburst)'), ('AGN (Active Galactic Nucleus)', 'AGN (Active Galactic Nucleus)'), ('QSO (Optically Bright AGN)', 'QSO (Optically Bright AGN)'), ('Quasar (Optical and Radio Bright AGN)', 'Quasar (Optical and Radio Bright AGN)'), ('RQ-AGN (Radio-Quiet AGN)', 'RQ-AGN (Radio-Quiet AGN)'), ('RL-AGN (Radio-Loud AGN)', 'RL-AGN (Radio-Loud AGN)'), ('RG (Radio Galaxy)', 'RG (Radio Galaxy)'), ('BzK (BzK-selected Galaxy)', 'BzK (BzK-selected Galaxy)')])
