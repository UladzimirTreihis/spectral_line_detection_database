...
class Line(db.Model):
    ...
    observed_line_redshift = db.Column(db.Float(32))
    observed_line_redshift_uncertainty_positive = db.Column(db.Float(32))
    observed_line_redshift_uncertainty_negative = db.Column(db.Float(32))
