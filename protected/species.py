...
Ethynyl_Methylidynium_Mathylidyne = {"CCH": CCH_f, "CH+": CH_PLUS_f, "CH2_P1/2": CH2_P1_SLASH_2_f,
                                     "CH2_P3/2": CH2_P3_SLASH_2_f}
...
CI_BRACKET_C_HYPHEN_atom_BRACKET = {"CI(C-atom)": "CI(C-atom)", "C": "CI(C-atom)", "Ci": "CI(C-atom)",
                                    "CI": "CI(C-atom)"}
CII = {"CII": "CII", "C+": "CII"}
